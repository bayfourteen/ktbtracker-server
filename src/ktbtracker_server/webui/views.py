...
from ktbtracker_server.webui.admin.views import router as admin_router
from ktbtracker_server.webui.auth.views import router as auth_router
from ktbtracker_server.webui.tracking.views import router as tracking_router
